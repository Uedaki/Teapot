...
VkExtent2D VulkanContext::chooseSwapExtent(GLFWwindow *win, const VkSurfaceCapabilitiesKHR &capabilities)
{
...
VulkanContext::QueueFamilyIndice VulkanContext::findQueueFamilies(VkPhysicalDevice device)
{
