...
namespace
{
	void createRenderPass(teapot::Rasterizer &rast, ctm::VkCore &core)
	{
	...
	void createPipeline(teapot::Rasterizer &rast, ctm::VkCore &core)
	{
	...
	void createImage(teapot::Rasterizer &rast, ctm::VkCore &core, VkImage &image)
	{
	...
	void createFrameBuffer(ctm::VkCore &core, teapot::Rasterizer &rast, VkFramebuffer &frame, VkImageView &imageView)
	{
	...
	void createDescriptorSetLayout(teapot::Rasterizer &scene, ctm::VkCore &core)
	{
	...
	void createImageSampler(teapot::Rasterizer &scene, ctm::VkCore &core)
	{
...
void teapot::Rasterizer::destroy(teapot::Rasterizer &rast, ctm::VkCore &core)
{
	...
	vkDestroySampler(core.device, rast.imageSampler, core.allocator);
